    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__brands__5E5A8E275262908A", x => x.brand_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__categori__D54EE9B4B1639467", x => x.category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__customer__CD65CB85E38AB578", x => x.customer_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stores__A2F2A30CC25AEF5D", x => x.store_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__products__47027DF5DBECC338", x => x.product_id);
                    table.ForeignKey(
                        name: "FK__products__brand___44FF419A",
                        column: x => x.brand_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__staffs__1963DD9C6CC0C4AE", x => x.staff_id);
                    table.ForeignKey(
                        name: "FK__staffs__manager___60A75C0F",
                        column: x => x.manager_id,
                        principalSchema: "sales",
                        principalTable: "staffs",
                        principalColumn: "staff_id");
                    table.ForeignKey(
                        name: "FK__staffs__store_id__5FB337D6",
                        column: x => x.store_id,
                        principalSchema: "sales",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D354F21062", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
                        name: "FK__stocks__product___6EF57B66",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__stocks__store_id__6E01572D",
                        column: x => x.store_id,
                        principalSchema: "sales",
                        principalTable: "stores",
                        principalColumn: "store_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__orders__465962299792D271", x => x.order_id);
                    table.ForeignKey(
                        name: "FK__orders__customer__6477ECF3",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__orders__staff_id__66603565",
                        column: x => x.staff_id,
                        principalSchema: "sales",
                        principalTable: "staffs",
                        principalColumn: "staff_id");
                    table.ForeignKey(
                        name: "FK__orders__store_id__656C112C",
                        column: x => x.store_id,
                        principalSchema: "sales",
                        principalTable: "stores",
                        principalColumn: "store_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D47C26A5DE", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
                        name: "FK__order_ite__order__6A30C649",
                        column: x => x.order_id,
                        principalSchema: "sales",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__order_ite__produ__6B24EA82",
                        column: x => x.product_id,
                        principalSchema: "production",
                        principalTable: "products",
                        principalColumn: "product_id",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E61644BA42F5E",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
